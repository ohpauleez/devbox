...
The living design doc under [`docs/design.md`](docs/design.md) is the durable design intent for the project and the main technical documenation. This file complements it by mapping that design onto the code that exists in this repository.
